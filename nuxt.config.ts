...
export default defineNuxtConfig({
  ...
  critters: {
    ...
    preconnect: ['https://1337x.lol'], // Preconectar a dominios necesarios
  },
  experimental: {
  ...
  app: {
    head: {
      ...
      link: [
        ...
        { rel: 'preconnect', href: 'https://1337x.lol'},
      ...
      script: [
        {
          innerHTML: `
            var _Hasync = _Hasync || [];
            _Hasync.push(['Histats.start', '1,5053851,4,0,0,0,00011001']);
      ...
      noscript: [
        {
          innerHTML: '<a href="/" target="_blank"><img src="//sstatic1.histats.com/0.gif?5053851&101" alt="free hit counter code" border="0"></a>'
        },
      ],
    }
  },
  ...
  robots: {
    UserAgent: '*',
    Allow: '/',
    Sitemap: 'https://1337x.lol/sitemap_index.xml'
  },
  sitemap: {
    ...
    sitemaps: {
      ...
      posts: {
        ...
        sources: [[
          'https://1337x.lol/api/posts/slugs',
